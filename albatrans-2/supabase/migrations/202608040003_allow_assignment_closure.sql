...
begin
  ...
  elsif tg_table_name = 'driver_vehicle_assignments' and (tg_op = 'INSERT' or new.driver_id is distinct from old.driver_id or new.vehicle_id is distinct from old.vehicle_id or new.organization_id is distinct from old.organization_id) then
