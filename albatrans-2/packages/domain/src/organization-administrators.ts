import type { AdministratorIdentityErrors, AdministratorIdentityInput } from "@albatrans/contracts";

export function validateAdministratorIdentity(input: AdministratorIdentityInput): { valid: boolean; errors: AdministratorIdentityErrors } {
  const errors: AdministratorIdentityErrors = {};
...
export function normalizeAdministratorIdentity(input: AdministratorIdentityInput): AdministratorIdentityInput {
...
export function canAssignAdministrator(assignedCount: number, effectiveLimit: number | null): boolean {
